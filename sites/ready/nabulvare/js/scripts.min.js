...
$(function() {
	...
	//инициализация и настройка меню
	$("#my-menu").find( ".mm-panel" ).first().removeClass( "mm-hasnavbar" );
	$('#my-menu').mmenu({
		extensions:[ 'theme-black', 'effect-menu-slide', 'pagedim-black', "position-right"],
 		navbar:{
			title: '<img src="img/src/logo.svg" alt="Парикмахерская На Бульваре">'
		}
	});
	...
	//определение инициализации карусели
	...
	$('.carousel-services').owlCarousel({
		...
		smartSpeed: 900,	//скорость прокрутки
		dots:false,			//отключение dots
		navText: ['<i class="fa fa-caret-left"></i>', '<i class="fa fa-caret-right"></i>'],	//вид навигационных стрелок
		//адаптация для мониторов
	...
	//определение высоты картинки карусели
	...
	//функция выделения слова (через регулярные выражения)
	...
	//оформление select через плагин
	$('select').selectize({	});

	//маска телефонного номера для инпута
	$("#phone").mask("+7 (999) 999-9999");
	//при клике перемещение курсора в начало строки
	$('#phone').on('click', function() {
		$("#phone").focus();
		var rng=$("#phone");//.createTextRange();
		rng.collapse()
	...
	//изменение размера
	function onResize() {
		//настройка вида блоков (чтобы не выбивался item при длинном списке)
